                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-8'>
                        ...
                        <div className='p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all'>
                            ...
                            <div className='space-y-4 text-gray-300'>
                                <div>
                                    <h4 className='font-semibold'>React Developer at IGap Technology Kolhapur</h4> 
                                    <p>
                                        Training based Internship where Gained hands on experiece in frontend development UI design bootstrap and Collaborated with a team to develop Ecommerce website with Admin page CRUD operations.
                                    </p>
                                </div>
                                <div>
                                    <h4 className='font-semibold'>Java Fullstack development at Jsider Pune</h4> 
                                    <p>
                                        Training based Internship where Gained full knowledge in java fullstack development from scratch and Devops tools and implemented my skills to work on project.
                                    </p>
                                </div>
                            </div>
                        </div>
